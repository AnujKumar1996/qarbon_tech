...
def closes_troubleticket_by_id(id, buyerId, sellerId):
    try:
        ...
        if troubleticket_item_data.get("status") != "closed" :
            
            troubleticket_item_data["status"]="closed"
            ...
            status_msg_code = 422
            message = "The trouble ticket has already been set to the 'closed' status."
            reason = "The troubleTicket is remains closed"
            reference_error = None
