...
def troubleticket_state_change_event(info):
    ...
    try:
        ...
        if info.eventType != "troubleTicketStatusChangeEvent":
            status_msg_code = 422
            message = "The eventType must be 'troubleTicketStatusChangeEvent'"
        ...
        if info.event.id not in list_of_keys :
            ...
            previous_state = troubleticket_data.get("previousStatus")
            
            if current_state != previous_state:
                troubleticket_data["previousStatus"] = current_state
                ...
                reason = "The troubleTicket remains in its current state."
                reference_error = None
