...
def troubleticket_information_requiredevent(info):
    ...
    try:
        ...
        if info.eventType != "troubleTicketInformationRequiredEvent":
            status_msg_code = 422
            message = "The eventType must be 'troubleTicketInformationRequiredEvent'"
        ...
        if info.event.id not in list_of_keys :
            ...
            if current_state == "pending":
                ...
                reason = "The trouble ticket is not in 'pending' state"
                reference_error = None
