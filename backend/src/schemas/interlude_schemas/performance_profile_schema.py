...
class PerformanceProfile(PerformanceProfile_Common):
    ...
    rejectionReason: Optional[str] = Field(
        default="", description="Reason in case creation request was rejected."
    )
...
class PerformanceProfile_Find(BaseModel):
    ...
    description: Optional[str] = Field(
        default="", description="A free-text description of the Performance."
    )
    ...
    reportingPeriod: Optional[ReportingperiodEnum] = Field(
        default="", description="Defines the interval for the report generation."
    )
...
class PerformanceProfile_Update(BaseModel):
    ...
    outputFormat   : Optional[OutputFormat] = Field(default="")
    reportingPeriod : Optional[Interval] =  Field(default="",description='Defines the interval for the report generation.')
    resultFormat    : Optional[ResultFormat] = Field(default="")
