...
sonata_payloads = current_directory/'sonata_payloads.json'
with open(sonata_payloads) as data:
	sonata_extra_payload = json.load(data)
sonata_extra_payload
...
qcl_states_file_name = 'qcl_states.json'
state_file_name = current_directory / qcl_states_file_name
with open(state_file_name) as state_data:
    qcl_states = json.load(state_data)
qcl_states
