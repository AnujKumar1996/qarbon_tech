...
def lists_or_finds_charge_objects(
    ...
    productOrderItemId: Optional[str] = Query("", 
    ...
    try:
        ...
        for _, order_info in json_data.items():
            ...
            if  ((productOrderId == "" or nested_product_order_id == productOrderId) and 
                (productOrderItemId == "" or nested_product_order_item_id == productOrderItemId) and
                (creationDate_lt == None or (json_creationDate and json_creationDate <= creationDate_lt)) and 
                (creationDate_gt == None or (json_creationDate and json_creationDate > creationDate_gt)) and 
                (responseDueDate_gt == None or (json_responseDue_Date and json_responseDue_Date > responseDueDate_gt)) and 
                (responseDueDate_lt == None or (json_responseDue_Date and json_responseDue_Date <= responseDueDate_lt)) and
