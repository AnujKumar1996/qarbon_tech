...
from src.schemas.sonata_schemas.customer_bill_management_schemas import CustomerBillItem
from src.common.exceptions import raise_exception

def retrieve_customer_bill_item_by_id(id):
    ...
    try:
        ...
        response_file = "customer_bill_item_management.json"
        ...
        if id in all_keys :
            ...
            json_compatible_item_data=jsonable_encoder(CustomerBillItem(**order_info))
