...
def catalog_product_offering_status_change_event(info):
    ...
    try:
        ...
        if info.eventType != "productOfferingStateChangeEvent":
            status_msg_code = 422
            message = "The eventType must be 'productOfferingStateChangeEvent'"
