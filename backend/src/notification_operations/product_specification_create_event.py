...
def productspecification_create_event_notification(info):
    ...
    try:
        ...
        if info.eventType != "productSpecificationCreateEvent":
            status_msg_code = 422
            message = "The eventType must be 'productSpecificationCreateEvent'"
